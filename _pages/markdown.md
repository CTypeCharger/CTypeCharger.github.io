...
* The Academic Pages template can include Markdown or JSON-based CV pages; see the [template repository](https://github.com/academicpages/academicpages.github.io) if you want to add them.
